...
for ABI in $ABIS; do
	...
	$TOOLCHAIN/bin/ld.lld src/*.o -o android/build/lib/$ABI/libmain.so -shared \
		...
		-L$TOOLCHAIN/sysroot/usr/lib/$LIBPATH/$ANDROID_VERSION_API \
...
$BUILD_TOOLS/aapt package -f -m \
	...
	-I $ANDROID_HOME/platforms/android-$ANDROID_VERSION_API/android.jar

# Compile NativeLoader.java
javac -verbose -source 1.8 -target 1.8 -d android/build/obj \
	-bootclasspath jre/lib/rt.jar \
	-classpath $ANDROID_HOME/platforms/android-$ANDROID_VERSION_API/android.jar:android/build/obj \
...
$BUILD_TOOLS/aapt package -f \
	...
	-I $ANDROID_HOME/platforms/android-$ANDROID_VERSION_API/android.jar -F game.apk android/build/dex
...
$ANDROID_HOME/platform-tools/adb install -r game.apk
